...
<header>
    <?php
    include APP_URL.'app/views/layouts/homeHeader.php';
    ?>
</header>
    ...
    <div class="slider-wrapper swiper-wrapper">
        <div class="slider-item swiper-slide">
            <div class="slide-content">
                ...
                <a href="<?php APP_URL; ?>/planes" class="slide-button"><span>Ver planes</span></a>
            </div>
        </div>
        <div class="slider-item swiper-slide">
            <div class="slide-content">
...
<section class="feature-section">
    <div class="features">
        <div class="features">
            <img src="<?php APP_URL; ?>/app/views/assets/img/gestion1.webp" alt="Gestión">
        ...
        <div class="features">
            <img src="<?php APP_URL; ?>/app/views/assets/img/automatizacion.webp" alt="Automatización">
        ...
        <div class="features">
            <img src="<?php APP_URL; ?>/app/views/assets/img/acesso.webp" alt="Acceso">
        ...
        <div class="features">
            <img src="<?php APP_URL; ?>/app/views/assets/img/comunicacion.webp" alt="Comunicación">
...
<section class="app-buttons">
    <div class="app-download">
        ...
        <img src="<?php APP_URL; ?>/app/views/assets/img/Byfrost.svg" alt="Byfrost Logo" width="100">
        <img src="<?php APP_URL; ?>/app/views/assets/img/playstore-badge.webp" alt="Google Play" width="200">
        <img src="<?php APP_URL; ?>/app/views/assets/img/appstore-badge.webp" alt="App Store" width="180">
    </div>
</section>
